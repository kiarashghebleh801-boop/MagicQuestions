...
export const chemistrySections: ChemistrySection[] = [
  {
    ...
    subtopics: [
      ...
      { code: "h", title: "Metallic bonding  ◆ PAPER 2 ONLY", specRange: "1.52C–1.54C" },
      { code: "i", title: "Electrolysis  ◆ PAPER 2 ONLY", specRange: "1.55C–1.60C" },
    ],
  },
  {
    number: 2,
    ...
    subtopics: [
      ...
      { code: "e", title: "Extraction and uses of metals  ◆ PAPER 2 ONLY", specRange: "2.22C–2.27C" },
  ...
  },
  {
    ...
    subtopics: [
      ...
      { code: "e", title: "Alcohols  ◆ PAPER 2 ONLY", specRange: "4.29C–4.33C" },
      { code: "f", title: "Carboxylic acids  ◆ PAPER 2 ONLY", specRange: "4.34C–4.37C" },
      { code: "g", title: "Esters  ◆ PAPER 2 ONLY", specRange: "4.38C–4.40C" },
      { code: "h", title: "Synthetic polymers  ◆ PAPER 2 ONLY", specRange: "4.41C–4.44C" },
    ],
  },
];
